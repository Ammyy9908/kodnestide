...
function App() {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <main className="w-full grid grid-cols-4 overflow-hidden">
        ...
        <div className=" h-full">
          <div className="bg-black/90 text-white px-2 py-3  overflow-y-scroll h-[95vh] max-h-[95vh]">
            <pre
              className={`${
                status !== "Accepted" ? "text-red-400" : "text-green-400"
              }`}
            >
              <code>{output}</code>
            </pre>
      ...
      <div
        className={`fixed bottom-10 left-10 ${
          status ? "w-[230px]" : "w-16"
        } px-2 py-2 bg-black shadow-2xl rounded-full flex items-center gap-2 transition-all`}
      >
        <button
          className="bg-blue-400 px-4  text-white w-12 h-12  rounded-full shadow-2xl"
